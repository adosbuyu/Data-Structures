...
my_array <- array(
  ...
  dim <- c(3,3,3),
  #row/column names
  dimnames <- list(c("ROW 1", "Row 2", "ROW 3"), c("COL 1", "LUNCH", "COCKROACHES"), c("MATRIX 1", "MATRIX RELOADED", "MATRIX 3"))
)
my_array
```
...
print("The first Matxix:")
matrix_1

print("The second Matxix:")
matrix_2
```
...
2.  In the above matrix that you created, print the value 5 by indexing in to the matrix.
    ...
    ```{r}
    print("From the first Matrix")
    matrix_1[2,2]
    print("From the second Matrix")
    matrix_2[2,2]
